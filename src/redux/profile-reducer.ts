...
const profileReducer = (
  ...
  state = initialState,
  action: ActionProfileReducersTypes,
): ProfilePageType => {
  switch (action.type) {
...
export type ActionProfileReducersTypes =
  | AddPostActionType
  | setUserProfileType
...
export const getUserProfile =
  (userId: number) => async (dispatch: Dispatch, getState: any) => {
    const { autorizedUserId } = getState().auth;
...
export const upDateProfile =
  (data: upDateProfileType) => async (dispatch: Dispatch, getState: any) => {
